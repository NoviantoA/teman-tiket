...
Route::prefix('/admin')->group(function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::match(['get', 'post'],
            '/add/banner',
            [AdminController::class, 'addBanner']
        )->name('admin.add.banner');
        // update banner
        Route::match(['get', 'post', 'put'
        ], '/update/banner/{banner_id}', [AdminController::class, 'updateBanner'])->name('admin.update.banner');
        // delete banner
        Route::match(['get', 'post'],
            '/delete/banner/{banner_id}',
            [AdminController::class, 'deleteBanner']
        )->name('admin.delete.banner');
    });
});