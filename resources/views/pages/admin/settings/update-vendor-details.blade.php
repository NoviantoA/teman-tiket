                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">Setting Vendor Details</h3>
                            <h6 class="font-weight-normal mb-0">Update Vendor <span class="text-primary">Information</span>
                            </h6>
                        </div>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ route('update.admin.details') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="admin_mobile"
                                            value="{{ Auth::guard('admin')->user()->mobile }}" maxlength="15" minlength="9"
                                            placeholder="Enter New Mobile Phone" name="admin_mobile" required="">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @if (!empty(Auth::guard('admin')->user()->image))
                                            <a target="_blank"
                                                href="{{ asset('store/admin/photo/' . Auth::guard('admin')->user()->image) }}">View
                                                Image</a>
