            ...
            <div class="container card shadow p-3">
                ...
                <div class="body-details mt-2   ">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="btn btn-disabled text-light"disabled>Waiting Payment</div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 d-flex ">
                            ...
                            <div class="col-6">
                                <p>Tanggal Bayar</p>
                                <p class="bg-warning w-50">Waiting Payment</p>
                            </div>
                        </div>
                    ...
                    <button class="btn col-12" width="100%">Lanjut Pembayaran</button>
                </div>
