    ...
    <div class="page-content page-home">
        <div class="container">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                        type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Succes
                        Transaction</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="card  mt-2 mb-2">
                        <div class="row p-3 d-flex align-items-center justify-content-between">
                            ...
                            <div class="col text-center">
                                <p class="btn btn-sm btn-success mb-0">View Invoices</p>
                            </div>
                        </div>
                    </div>
                    <div class="card  mt-2 mb-2">
                ...
                <div class="tab-pane fade" id="pills-failed" role="tabpanel" aria-labelledby="pills-contact-tab">failed
                </div>
            </div>
        </div>
    </div>
